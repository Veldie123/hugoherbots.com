...
const faqData: FAQItem[] = [
  {
    id: 1,
    question: "Wat is E.P.I.C. TECHNIQUE en hoe gebruik ik het?",
  ...
  },
  {
    ...
    answer: "Alle instructievideo's zijn te vinden in de Video's sectie in het hoofdmenu. De video's zijn georganiseerd per E.P.I.C. TECHNIQUE fase en techniek. Je kunt video's markeren als favoriet en je voortgang wordt automatisch bijgehouden.",
    category: "techniques",
  },
  {
    id: 5,
  ...
  },
  {
    ...
    answer: "Met gespreksanalyse kun je opnames van je verkoopgesprekken uploaden. Onze AI analyseert het gesprek en geeft je inzicht in welke E.P.I.C. TECHNIQUE je hebt gebruikt, wat goed ging en waar je kunt verbeteren. Upload je gesprek als MP3, WAV of M4A bestand.",
    category: "techniques",
  },
  {
    id: 7,
  ...
  },
  {
    ...
    answer: "Je score wordt berekend op basis van hoe goed je de E.P.I.C. TECHNIQUE toepast tijdens roleplays en gesprekken. De AI beoordeelt aspecten zoals timing, woordkeuze, en gesprekstechniek. Je ziet een totaalscore en scores per techniek.",
    category: "techniques",
  },
  {
    id: 11,
...
const quickLinks = [
  ...
  { label: "E.P.I.C. TECHNIQUE", icon: Target, page: "library" },
