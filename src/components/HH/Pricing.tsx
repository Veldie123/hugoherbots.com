...
export function Pricing({ navigate }: PricingProps) {
  ...
  const plans: Array<{
    ...
    },
    {
      ...
      features: [
        "Alles van Pro",
        "Dagelijkse live sessies (ma–vr) met Hugo + Q&A",
        "Onmiddellijk herbekijken van live sessies",
        "Priority analyse van je gesprekken",
        "Priority support",
    ...
    },
    {
      ...
      features: [
        "Alles van Founder",
        "Exclusieve 1-op-1 coaching calls met Hugo",
        "Directe lijn met Hugo (WhatsApp/Slack)",
        "Priority analyse van je gesprekken",
        "Je naam in de product roadmap",
  ...
  const featureComparison = [
    {
      ...
      features: [
        { name: "AI-avatar simulaties", pro: "Onbeperkt", founder: "Onbeperkt", innerCircle: "Onbeperkt" },
    ...
    },
    {
      ...
      features: [
        { name: "Dagelijkse live sessies (ma–vr) met Hugo", pro: false, founder: true, innerCircle: true },
        { name: "Live sessies herbekijken", pro: false, founder: true, innerCircle: true },
        { name: "Exclusieve 1-op-1 coaching calls met Hugo", pro: false, founder: false, innerCircle: true },
        { name: "Directe lijn met Hugo (WhatsApp/Slack)", pro: false, founder: false, innerCircle: true },
      ],
    },
    {
      category: "Analyse & Personalisatie",
      features: [
        { name: "Priority analyse van je gesprekken", pro: false, founder: true, innerCircle: true },
        { name: "Custom scenario's op maat", pro: false, founder: false, innerCircle: true },
        { name: "Je naam in de product roadmap", pro: false, founder: false, innerCircle: true },
      ],
    },
    {
      ...
      features: [
        ...
        { name: "Dedicated onboarding", pro: false, founder: false, innerCircle: true },
      ],
    },
  ];
