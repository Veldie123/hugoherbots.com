...
export function VideoLibrary({ navigate, isAdmin, adminViewMode, onboardingMode, isPreview, navigationData }: VideoLibraryProps) {
  ...
  return (
    <AppLayout currentPage="videos" navigate={navigate} isAdmin={isAdmin} onboardingMode={onboardingMode} isPreview={isPreview}>
      <div className="p-3 sm:p-4 lg:p-6 space-y-6">
        {/* Header with compact KPI cards on the right */}
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
          <div>
            <h1 className="text-[24px] sm:text-[28px] lg:text-[32px] leading-[40px] font-light text-hh-text mb-2">
              Video Bibliotheek
            </h1>
