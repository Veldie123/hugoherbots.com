        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
          <div>
            ...
            <p className="text-[14px] leading-[22px] sm:text-[16px] sm:leading-[24px] lg:text-[18px] lg:leading-[26px] text-hh-muted mb-6">
              ...
              €2.000 per halve dag betaalt. Maar voor elke salesprof die beter
              wil worden.
            </p>
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              ...
              <Button size="lg" variant="outline" className="gap-2 w-full sm:w-auto" onClick={() => handleNavigate("preview")}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 text-center">
            {[
              ...
              { number: "€2K", label: "Live halve dag training", suffix: "" },
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-20">
        <div className="space-y-8">
          ...
          <div>
            ...
            <p className="text-[18px] leading-[26px] text-hh-muted">
              Maar ik kreeg steeds meer vragen: "Kan ik niet vaker met je
              oefenen?" "Kun je niet altijd beschikbaar zijn?" Het antwoord was
              simpel: natuurlijk niet. Tot nu.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-[18px] leading-[26px] text-hh-muted">
              Dus heb ik alles wat ik weet in een AI-coach gestopt. Mijn avatar
              oefent met je, geeft feedback zoals ik dat zou doen, en is 24/7
              beschikbaar. Voor de prijs van één lunch per maand.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="order-2 lg:order-1">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                { label: "€2.000", desc: "Per halve dag live" },
