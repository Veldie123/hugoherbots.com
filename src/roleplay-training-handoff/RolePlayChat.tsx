...
export function RolePlayChat({ navigate }: RolePlayChatProps) {
  ...
  return (
    <AppLayout currentPage="roleplaychat" navigate={navigate}>
      <div className="h-[calc(100vh-64px)] flex flex-col">
        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          {/* Main Content - Chat/Audio/Video Interface */}
          <div className="flex-1 flex flex-col overflow-hidden bg-hh-ui-50">
            {state === "idle" ? (
              /* Idle State - Empty State with 3 CTAs */
              ...
              /* Active State - Mode-specific Interfaces */
              <>
                {/* CHAT MODE */}
                {sessionMode === "chat" && (
                  <>
                  ...
                  <div className="flex-1 flex flex-col items-center justify-center p-8 bg-gradient-to-br from-hh-ui-50 to-hh-primary/5">
                    <div className="text-center max-w-md space-y-6">
                      ...
                      <div className="relative w-48 h-48 mx-auto">
                        ...
                        <div className="absolute inset-8 rounded-full bg-gradient-to-br from-hh-primary to-hh-slate-gray shadow-hh-lg flex items-center justify-center">
                          {isRecording ? (
                            <div className="flex gap-1">
          ...
          <DialogContent className="max-w-2xl">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <p className="text-[16px] leading-[24px] text-hh-muted">
                  "Goed begin! Probeer je vragen nog meer te structureren volgens de BANT methodiek. Blijf oefenen met timing en doorvragen."
                </p>
              </div>
            </div>
